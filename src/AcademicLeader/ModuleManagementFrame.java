...
public class ModuleManagementFrame extends javax.swing.JFrame {
    ...
    loadModules();        // TODO add your handling code here:
    ...
    try (BufferedReader br = new BufferedReader(new FileReader("module.txt"))) {
        ...
        while ((line = br.readLine()) != null) {
            ...
            // skip (delete) only THIS leader's selected module
            if (!(data[0].equals(moduleID) && data[2].equals(currentLeaderID))) {
                updated.add(line);
            }
        }
    ...
    try (PrintWriter pw = new PrintWriter(new FileWriter("module.txt", true))) {
